...
const Shipment = (props) => {
  ...
  const stripePromise = loadStripe(
    "pk_test_51Ie0tjKQTC12sVSNpQLfknOBcapZA9DdIiXVjfvGdyYgpUvbH9Q39hW4YSb8jACk0IVZrnEkJmROJqt4uTBBeRub00K0WfgN4H"
  );
      ...
      <div className="row">
        ...
        <div className="offset-md-2 col-md-5">
          <div className="restaurant-info mb-5">
            <h4>
              Form <strong> Pomato Restaura</strong>
            </h4>
